...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/scorec-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/scorec-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `scorec` available on your platform:
...
```
pixi search scorec --channel conda-forge
```
